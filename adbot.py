...
DEFAULT_CONFIG = {
    ...
    "announcement_message": "برای اجاره بات به آیدی @HR.__.AMIR پیام دهید!"
}
...
async def main():
    ...
    api_token = os.getenv("API_TOKEN", "8d81b297ca43dc17f4965967ce31d2eabbc6301634b94da58e2316b811b2b054")
